...
/*------------Start package them price Icon Preview SCRIPT---------*/
function icon_preview() {
    var x = document.getElementById("iconid").value;
    document.getElementById("show_icon").innerHTML=x;
}
function icon_preview2() {
	
    var x = document.getElementById("iconid2").value;
    document.getElementById("show_icon2").innerHTML=x;
}
/*------------End package them price Icon Preview SCRIPT---------*/

/*------------Start Slug Url SCRIPT---------*/

function slug_url(get,id)
{
	var data=$.trim(get); // trim data in string
...
/*------------Start Checkall (delete) Tour Categories SCRIPT---------*/
...
function ischeckbox()
				{
				   ...
				   for(var i=0; i< checkbox.length; i++) {
                    ...
                    if(ln==0)
					{
						noty({text: 'please select atleast one checkbox', layout: 'topRight', type: 'warning'});
					} else{ 
...
/*------------End Checkall (delete) Tour Package them SCRIPT---------*/
/*------------start  Tour Package setting Inclusion SCRIPT---------*/
function incclusion()
{
	var checkbox = document.getElementsByName('checklist[]');
				   var ln = 0;
...
$(document).ready(function(){ 
    $("#selectall_Inclusion").change(function(){
      $(".checkbox2").prop('checked', $(this).prop("checked"));
      });
});
function continue_delete_pac_inclusion()
{
	 $("#package_incclusion_selected_delet").submit();
}

/*------------End Tour Package setting Inclusion SCRIPT---------*/

/*------------start  Tour Package setting Exclusion SCRIPT---------*/
function ischeckbox3()
{
	var checkbox = document.getElementsByName('checklist[]');
				   var ln = 0;
				   for(var i=0; i< checkbox.length; i++) {
...
$(document).ready(function(){ 
    $("#selectall_Exclusion").change(function(){
      $(".checkbox3").prop('checked', $(this).prop("checked"));
      });
});
function continue_delete_select_exclusion()
{
	 $("#continue_delete_select_Exclusions").submit();
}

/*------------End Tour Package setting Exclusion SCRIPT---------*/
/*------------start  Tour Package setting City SCRIPT---------*/
function ischeckboxanilcity()
{
	var checkbox = document.getElementsByName('checklist[]');
				   var ln = 0;
				   for(var i=0; i< checkbox.length; i++) {
...
$(document).ready(function(){ 
    $("#selectall_city").change(function(){
      $(".checkbox4").prop('checked', $(this).prop("checked"));
      });
});
function delete_singleanilcity()
{
	 $("#delete_multicityanil").submit();
}

/*------------End Tour Package setting City SCRIPT---------*/
/*------------start  Tour-Hotel hotel Setting Hotel Type SCRIPT---------*/
function ischeckbox_ah()
{
	var checkbox = document.getElementsByName('checklist[]');
				   var ln = 0;
				   for(var i=0; i< checkbox.length; i++) {
...
$(document).ready(function(){ 
    $("#selectall_hy").change(function(){
      $(".checkbox1").prop('checked', $(this).prop("checked"));
      });
});
function delete_hotetype()
{
	 $("#FORM_HY").submit();
}
/*------------End Tour-Hotel hotel Setting Hotel Type SCRIPT---------*/
/*------------start  Tour-Hotel hotel Setting Room Type SCRIPT---------*/
function ischeckbox_RY()
{
	var checkbox = document.getElementsByName('checklist[]');
				   var ln = 0;
				   for(var i=0; i< checkbox.length; i++) {
                    ...
                    if(ln==0)
					{
						noty({text: 'please select atleast one checkbox', layout: 'topRight', type: 'warning'});
					     ...
					     var box = $("#mb-remove-row-room-type");
                         box.addClass("open");
...
$(document).ready(function(){ 
    $("#selectall_RY").change(function(){
      $(".checkbox2").prop('checked', $(this).prop("checked"));
      });
});
function delete_hotetroomype()
{
	 $("#Form_RoomType").submit();
}
/*------------End Tour-Hotel hotel Setting Room Type SCRIPT---------*/
/*------------start  Tour-Hotel hotel Setting Payment Type SCRIPT---------*/
function ischeckbox_PT()
{
	var checkbox = document.getElementsByName('checklist[]');
				   var ln = 0;
				   for(var i=0; i< checkbox.length; i++) {
                    ...
                    if(ln==0)
					{
						noty({text: 'please select atleast one checkbox', layout: 'topRight', type: 'warning'});
					     ...
					     var box = $("#mb-remove-row-payment-type");
                         box.addClass("open");
...
$(document).ready(function(){ 
    $("#selectall_PM").change(function(){
      $(".checkbox3").prop('checked', $(this).prop("checked"));
      });
});
function delete_hotetpaymenttype()
{
	 $("#Form_paymenttype").submit();
}
/*------------End Tour-Hotel hotel Setting Room Type SCRIPT---------*/
/*------------start  Tour-Hotel hotel Setting Amenties Type SCRIPT---------*/
function ischeckbox_AT()
{
	var checkbox = document.getElementsByName('checklist[]');
				   var ln = 0;
				   for(var i=0; i< checkbox.length; i++) {
                    ...
                    if(ln==0)
					{
						noty({text: 'please select atleast one checkbox', layout: 'topRight', type: 'warning'});
					     ...
					     var box = $("#mb-remove-row-amenties-type");
                         box.addClass("open");
...
$(document).ready(function(){ 
    $("#selectall_AT").change(function(){
      $(".checkbox4").prop('checked', $(this).prop("checked"));
      });
});
function delete_hotetamentiestype()
{
	 $("#Form_hotelamentiestype").submit();
}
/*------------End Tour-Hotel hotel Setting Room Type SCRIPT---------*/
/*------------start  Tour-Hotel hotel Setting Amenties Type SCRIPT---------*/
function ischeckbox_RMY()
{
	var checkbox = document.getElementsByName('checklist[]');
				   var ln = 0;
				   for(var i=0; i< checkbox.length; i++) {
                    ...
                    if(ln==0)
					{
						noty({text: 'please select atleast one checkbox', layout: 'topRight', type: 'warning'});
					     ...
					     var box = $("#mb-remove-row-roomamenties-type");
                         box.addClass("open");
...
$(document).ready(function(){ 
    $("#selectall_RoT").change(function(){
      $(".checkbox5").prop('checked', $(this).prop("checked"));
      });
});
function delete_roomamentiestype()
{
	 $("#Form_roomamentiestype").submit();
}
/*------------End Tour-Hotel hotel Setting Room Type SCRIPT---------*/