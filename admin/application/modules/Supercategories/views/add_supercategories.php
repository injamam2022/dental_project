               <!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                    ...
                    <li><a href="<?php echo site_url('Supercategories/add_supercategories');?>">Add Sub Sub Category</a></li>
                  <li class="active">AddSubSubCategory</li>
                </ul>
                <!-- END BREADCRUMB -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
					           ...
					           <br/>
                                  ...
                                  action="<?php echo site_url("Supercategories/add_supercategories"); ?>" enctype="multipart/form-data">         
...
<!--                                            <span class="help-block">This is required Select box</span>-->
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label"> Supercategory Description</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
