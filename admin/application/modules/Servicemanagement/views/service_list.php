...
<ul class="breadcrumb">
    ...
    <li class="active"><a href="<?php echo site_url('Servicemanagement'); ?>">Service List</a></li>
...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        ...
        <div class="btn-group pull-right" style="margin-right: 2%;">
            <a href="<?php echo site_url('Servicemanagement/add_services');?>">
    ...
    <div class="panel-body">
        <form id="form1" method="post" action="<?php echo site_url("Servicemanagement/multi_pro_del");?>">
                   ...
                   // printarray($cat_list);
					if($products){
                        ...
                        <tr>
                           ...
                           <td>
                                <?php echo $productlist->product_code; ?>
                            </td>
                             <td>
                            ...
                            <td>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <label class="switch">
                                            <input type="checkbox" onClick='confirm_del("<?php echo $productlist->ser_id;?>")' name="maintain_ration" class="maintain_ration" <?php if($productlist->status =="active"){ echo "checked"; } else { } ?> value="
                            ...
                            <td>
                             <?php $id=encode_url($productlist->ser_id);?>
                                    <a class="btn btn-default btn-rounded btn-sm" href="<?php echo site_url("Servicemanagement/edit_service/$id");?>"><span class="fa fa-pencil"></span></a>
                                    <a class="btn btn-danger btn-rounded btn-sm" onClick='confirm_delete("<?php echo encode_url($productlist->ser_id);?>")'><span class="fa fa-times"></span></a>
                            </td>
                        </tr>
                        <?php  } }   ?>
                </tbody>
...
<script>
    ...
    function delete_single() {
        ...
        window.location.href = "<?php echo site_url('Servicemanagement/delet_products');?>/" + id;
    }
</script>
...
<script>
    ...
    function Deactive_product() {
        window.location.href = "<?php echo site_url('Servicemanagement/product_act_inactive');?>/" + id;
    }
