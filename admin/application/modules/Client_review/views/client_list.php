...
<ul class="breadcrumb">
    ...
    <li class="active"><a href="<?php echo site_url('Client_review'); ?>">Client Message List</a></li>
...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        <h3 class="panel-title">Client Message List</h3>
        ...
        <div class="btn-group pull-right" style="margin-right: 2%;">
            <a href="<?php echo site_url('Client_review/add_data');?>">
                <button class="btn btn-primary"><i class="fa fa-plus-circle"></i> Add Content</button>
            </a>
        </div>
    </div>
    <!-- END HEADER SCETION -->
    <div class="panel-body">
        <form id="form1" method="post" action="<?php echo site_url("Client_review/multi_del");?>">
                ...
                <tbody>
					...
					if($HomepageContent_fatch){
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $HomepageContent_fatch_lists->client_name; ?>
                            </td>
							 <td>
                                <?php echo $HomepageContent_fatch_lists->client_message; ?>
                            </td>
                            ...
                            <td>
                                <?php $id=encode_url($HomepageContent_fatch_lists->id);?>
                                    <a class="btn btn-default btn-rounded btn-sm" href="<?php echo site_url("Client_review/edit_data/$id");?>"><span class="fa fa-pencil"></span></a>
...
<script>
    ...
    function delete_single() {
        ...
        window.location.href = "<?php echo site_url('Client_review/delet_data');?>/" + id;
    }
</script>
...
<script>
    ...
    function Deactive_banner() {
        window.location.href = "<?php echo site_url('Client_review/act_inactive');?>/" + id;
    }
