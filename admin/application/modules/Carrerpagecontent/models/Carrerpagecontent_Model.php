<?php class Carrerpagecontent_Model  extends MY_Model{
	
	
	function all_fatch_content($table)
	{
		$this->db->order_by('carrer_id','desc');
...
function first_images_upload()
{
    ...
    if(sizeof($errors)==0)
    {
      ...
      $config['upload_path'] = FCPATH . '/webroot/uploads/carrer';
