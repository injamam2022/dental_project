...
<ul class="breadcrumb">
    ...
    <li class="active"><a href="<?php echo site_url('gallery'); ?>">Gallery Image</a></li>
...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        ...
        <div class="btn-group pull-right" style="margin-right: 2%;">
            <a href="<?php echo site_url('gallery/add_gallery');?>">
                <button class="btn btn-primary"><i class="fa fa-plus-circle"></i> Add Gallery Image</button>
            </a>
        </div>
    </div>
    <!-- END HEADER SCETION -->
    ...
    <?php //printarray($Banner_fatch); ?>
    <div class="panel-body">
        <form id="form1" method="post" action="<?php echo site_url("gallery/multi_banner_del");?>">
...
<!--							 <td>
                            ...
                            <td>
                                <?php
                                if($Banner_lists->image_category == 2){
                                ?>
                                <img src="<?php echo site_url('webroot/uploads/banner').'/'.$Banner_lists->image_name;?>" alt="Smiley face" height="42" width="42" />
                            <?php } ?>
                                
                                <?php
                                if($Banner_lists->image_category == 1){
                                ?>
                                 <?php echo $Banner_lists->youtube_url_link; ?>
                                <?php } ?>
                            </td>
                            <td>
                                <?php    if($Banner_lists->image_category == 1){ echo "Youtube"; }	
                                
                                         if($Banner_lists->image_category == 2){ echo "Image"; }
                            ...
                            <td>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <label class="switch">
                                            <input type="checkbox" onClick='confirm_del("<?php echo $Banner_lists->id;?>")' name="maintain_ration" class="maintain_ration" <?php if($Banner_lists->status =="active"){ echo "checked"; } else { } ?> value="
                            ...
                            <td>
                                <?php $id=encode_url($Banner_lists->id);?>
                                    <a class="btn btn-default btn-rounded btn-sm" href="<?php echo site_url("gallery/edit_banner/$id");?>"><span class="fa fa-pencil"></span></a>
                                    <a class="btn btn-danger btn-rounded btn-sm" onClick='confirm_delete("<?php echo encode_url($Banner_lists->id);?>")'><span class="fa fa-times"></span></a>
                            </td>
                        </tr>
                        <?php  } }   ?>
                </tbody>
...
<script>
    ...
    function delete_single() {
        ...
        window.location.href = "<?php echo site_url('gallery/delet_banner');?>/" + id;
    }
</script>
...
<script>
    ...
    function Deactive_banner() {
        window.location.href = "<?php echo site_url('gallery/banner_act_inactive');?>/" + id;
    }
