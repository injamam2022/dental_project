...
foreach($customer_list as $cval){
?>				
<tr>
<td><?php echo $i; ?></td>
<td><a href="<?php echo site_url('customer/details/'.$cval->id.''); ?>" ><span class="label label-success" style="font-size: 100%;cursor: pointer;"><?php echo $this->customersuffix.$cval->id; ?></span></a></td>
<td><?php echo $cval->first_name;?></td>
<td><?php echo $cval->last_name;?></td>
<td><?php echo $cval->country_dial_code.' '.mydecryption($cval->contact_number);?></td>
<td><?php echo ($cval->email_id);?></td>
<td><?php echo ($cval->create_date);?></td>
<td>
<a href="<?php echo site_url('customer/delete/'.$cval->id.''); ?>" class="btn btn-danger btn-rounded btn-sm" onclick="return confirm('Are you sure want to delete ?');"><span class="fa fa-times"></span></a>
</td>                                               
</tr>	
<?php 
$i++;
