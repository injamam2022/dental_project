<!-- START BREADCRUMB -->
            ...
            <div class="page-content-wrap">
                <div class="row">
                    <div class="col-md-12">
                        <form id="add_page"class="form-horizontal" method="post" action="<?php echo site_url("blog/insert");?>" enctype="multipart/form-data" >
                            <div class="panel panel-default">
                                ...
                                <h3 class="panel-title"><strong>Add Blog</h3>
                                </div>
                               <p style="margin:7px;"> 
											...
											<div class="col-md-6 col-xs-12">
											 <label>Post Title</label>
												<div class="input-group">
													...
													<input type="text" name="post_title" onblur="slug_url(this.value,'category_title')" placeholder="Enter Post Title" class="form-control" required />
												</div>            
											</div>
											<div class="form-group">
								      ...
								      <div class="col-md-12">
										 <div class="form-group"> 
										   <div class="input-group">
											 ...
											 <textarea   name="summernote" class=""rows="10" cols="100"> </textarea> 
											 </div><br><br>
										  </div>
									   </div>
									   <div class="col-md-10 col-xs-12">
											 <label>Post Tag</label>
												<div class="input-group">
													<span class="input-group-addon"><span class="fa fa-pencil"></span></span>
													<input type="text" name="tag" placeholder="Enter Post Tag" class="form-control" required />
												</div> <br><br>           
											</div>
                                        ...
                                        <div class="col-md-12 col-xs-12">
								         ...
								         <!--<div class="col-md-4 col-xs-12"><br><br>
										   ...
										   { ?>
										   <option value="<?php echo $cat->id;?>" <?php if($get_category->name == $cat->id){ echo "selected"; } ?> > <?php echo $cat->name;?> </option>
										   ...
										   <?php } ?>
											...
											<!--<div class="col-md-4 col-xs-12"><br><br>
												 ...
												 <option value="<?php echo $related_post->id;?>" <?php if($get_category->post_title == $related_post->id){ echo "selected"; } ?> > <?php echo $related_post->post_title;?> </option>
											   <?php } ?>
												</select>         
											</div>-->
											<div class="col-md-8 col-xs-12">
											  ...
											  <label>Image</label>
												  <div class="form-group ">
													  <input type="file" class="fileinput btn-primary" name="uploadedimages[]" multiple id="category_thumb" title="Browse file" required />
												  </div><br><br>
												</div>       
											</div>
											 </div>
