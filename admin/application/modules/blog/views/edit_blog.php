    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form id="edit_blog_form" class="form-horizontal" method="post"
                ...
                <?php
                $blog_meta_title = (is_object($data) && property_exists($data, 'meta_title')) ? trim((string) $data->meta_title) : '';
                $blog_meta_description = (is_object($data) && property_exists($data, 'meta_description')) ? trim((string) $data->meta_description) : '';
                ?>
                <div class="blog-form-card">
                    <div class="blog-form-card-head">
                    ...
                    <div class="blog-form-card-body">
                        ...
                        <div class="blog-field">
                            ...
                            <input type="text" name="meta_title" class="form-control" maxlength="255"
                                ...
                                placeholder="<?php echo htmlspecialchars((string) $data->post_title, ENT_QUOTES, 'UTF-8'); ?>"/>
