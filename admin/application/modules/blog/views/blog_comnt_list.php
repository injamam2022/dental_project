...
<!--===================FOR CATEGORY POPUP END HERE===================================================-->	
                                ...
                                <div class="panel-body">
								   ...
								   <form id="form1"  method="post" action="<?php echo site_url("Blog/delete_multiple_comment");?>">
									...
									$this->db->where('id',$comments_lists->comment_at);
									$query=$this->db->get();
									$result= $query->result();				
								//	echo $this->db->last_query(); die();
									?>	
												 ...
												 <td><?php if($result[0]->post_title == ''){echo "You Delete this blog";}else{ echo $result[0]->post_title;}?></td>
												  ...
												  <td><?php echo $comments_lists->comment;?></td>
       ...
       <a href="" class="changestatus<?php echo $comments_lists->id;?>" thisId="<?php echo $comments_lists->id; ?>" status="<?php echo $comments_lists->status; ?>">
					...
					<?php echo $comments_lists->status; ?></button>
                    </a></td> 
					
														
<script>
$( document ).ready(function(){ 
$(".changestatus<?php echo $comments_lists->id; ?>").click(function(){
	
	var res=confirm('Do You Want To Change Status?');
	if(res==true)
	{
var thisId = $(this).attr("thisId");//alert(thisId);
var sts =  $(this).attr("status");//alert(sts);
...
window.location.href="<?php echo site_url();?>Comment-list";
                                                ...
                                                <td>
                                                 <?php $commentkey=$comments_lists->id;?>
												<a class="btn btn-danger btn-rounded btn-sm" onClick='confirm_delete("<?php echo $commentkey;?>")'><span class="fa fa-times"></span></a>
												</td>
