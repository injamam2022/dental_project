<?php class Testimonial_Model  extends MY_Model{
	
	
	function all_fatch_testimonial()
	{
...
function testimonial_images_upload()
	{
	$name_array= array();
    ...
    if(sizeof($errors)==0)
    {
      ...
      $config['upload_path'] = FCPATH . '/webroot/uploads/testimonial';
	...
	function delet_testimonial_single($id)
	{
		$this->db->where('tes_id',$id);
