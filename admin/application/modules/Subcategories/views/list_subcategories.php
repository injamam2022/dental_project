...
<ul class="breadcrumb">
    ...
    <li class="active"><a href="<?php echo site_url('Subcategories'); ?>">SubCategory List</a></li>
...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        <h3 class="panel-title">SubCategory List</h3>
        ...
        <div class="btn-group pull-right" style="margin-right: 2%;">
            <a href="<?php echo site_url('Subcategories/add_subcategories');?>">
                <button class="btn btn-primary"><i class="fa fa-plus-circle"></i> Add SubCategory</button>
            </a>
        </div>
    </div>
    <!-- END HEADER SCETION -->
    ...
    <div class="panel-body">
        <form id="form1" method="post" action="<?php echo site_url("Subcategories/multi_cat_del");?>">
                ...
                <tbody>
					...
					if($sup_cat_fatch){
                        ...
                        <tr>
                            <td style="padding: 0;">
                                <label class="check">
                                    <input type="checkbox" name="checklist[]" value="<?php echo $Sup_category_lists->sub_catid; ?>" class="checkbox1" />
                                </label>
                            </td>
                            <td>
                                <?php echo $key+1; ?>
                                         ...
                                         foreach($sup_cat_list as $key=>$list)
                                          {  
                                            // echo $list->super_catid;
                                             if($list->cat_id == $Sup_category_lists->cat_id)
                                             {
                                                echo $list->cat_name;
                                             }
                                          }
                           ...
                           <td>
                             ...
                             <td><img src="<?php echo site_url('webroot/uploads/sub_cat').'/'.$Sup_category_lists->cat_image;?>" alt="Smiley face" height="42" width="42" /></td>
                            <td>
                                <div class="form-group">
                                    <label class="col-md-2 control-label"></label>
                                    <div class="col-md-10">
                                        <label class="switch">
                                            <input type="checkbox" onClick='confirm_del("<?php echo $Sup_category_lists->sub_catid;?>")' name="maintain_ration" class="maintain_ration" <?php if($Sup_category_lists->status =="active"){ echo "checked"; } else { } ?> value="
                            ...
                            <td>
                             <?php $id=encode_url($Sup_category_lists->sub_catid);?>
                                    <a class="btn btn-default btn-rounded btn-sm" href="<?php echo site_url("Subcategories/edit_subcategories/$id");?>"><span class="fa fa-pencil"></span></a>
                                    <a class="btn btn-danger btn-rounded btn-sm" onClick='confirm_delete("<?php echo encode_url($Sup_category_lists->sub_catid);?>")'><span class="fa fa-times"></span></a>
                            </td>
                        </tr>
                        <?php  } }   ?>
                </tbody>
...
<script>
    ...
    function delete_single() {
        ...
        window.location.href = "<?php echo site_url('Subcategories/delet_subcategories');?>/" + id;
    }
</script>
...
<script>
    ...
    function Deactive_category() {
        window.location.href = "<?php echo site_url('Subcategories/subcategories_act_inactive');?>/" + id;
    }
