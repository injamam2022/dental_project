...
<ul class="breadcrumb">
  ...
  <li><a href="<?php echo site_url('Subcategories/edit_subcategories');?>">EditSubCategory</a></li>
  <li class="active">EditSubCategory</li>
</ul>
<!-- END BREADCRUMB -->
                ...
                <div class="panel-heading">
                                <h3 class="panel-title"><strong>EditSubCategory</h3>
                  <div class="btn-group pull-right" style="margin-right: 2%;">
                   <a href="<?php echo site_url('Subcategories');?>"><button class="btn btn-primary"><i class="fa fa-list-alt"></i>  Category List</button></a>
                   </div>
                                </div>
                ...
                ?>
                         <form id="cat_home" class="form-horizontal"  method="post" action="<?php echo site_url("Subcategories/update_subcategories/"); ?>"  enctype="multipart/form-data">                
                                <div class="form-group">                                        
                                     <label class="col-md-3 col-xs-12 control-label">Subcategory  Name </label>
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" name="cat_name" class="form-control" value="<?php echo $category->subcat_name?>" />
                                            </div>            
                                      ...
                                      <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label"> SubCategory Description</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                ...
                                <input type="hidden" name="subcat_id" value="<?php echo $category->sub_catid; ?>" />
                          ...
                          <img src="<?php echo site_url('webroot/uploads/sub_cat/'.$category->cat_image);?>" alt="Smiley face" height="50" width="50"/>
