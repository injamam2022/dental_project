...
/** /best-dental-clinic-in-kolkata only — “Dental” is the gold highlight in the welcome heading. */
$dental_landing_clinic = 'Dontia Care Clinic';
$dental_landing_clinic_esc = htmlspecialchars($dental_landing_clinic, ENT_QUOTES, 'UTF-8');
$dental_landing_highlight = 'Dental';
$dental_landing_highlight_esc = htmlspecialchars($dental_landing_highlight, ENT_QUOTES, 'UTF-8');
...
<div class="dental-page-view">
    ...
    <section class="dr-hero">
        ...
        <div class="dr-hero-content dr-container">
            <h2><?php echo $dental_landing_clinic_esc; ?></h2>
    ...
    <section id="about" class="dr-section dr-about">
        <div class="dr-container dr-grid">
            ...
            <div class="dr-about-photo">
                ...
                ?>
                <img src="<?php echo htmlspecialchars($about_img, ENT_QUOTES, 'UTF-8'); ?>" alt="<?php echo $dental_landing_clinic_esc; ?>" loading="lazy" decoding="async">
            </div>
        </div>
    </section>
    ...
    <section class="dr-section dr-google">
        <div class="dr-container">
            ...
            <p class="dr-sub">See what our patients are saying about their experience at <?php echo $dental_landing_clinic_esc; ?></p>
